{ pkgs, ... }: {
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      # The following command allows one to use Ctrl+l to clear the screen.
      # 
      # See also: https://github.com/christoomey/vim-tmux-navigator?tab=readme-ov-file#restoring-clear-screen-c-l
